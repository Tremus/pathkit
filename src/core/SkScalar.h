...
static inline SkScalar SkScalarFraction(SkScalar x) { return x - PkScalarTruncToScalar(x); }
...
static inline bool SkScalarIsInt(SkScalar x) { return x == PkScalarFloorToScalar(x); }
...
static inline bool SkScalarNearlyZero(SkScalar x, SkScalar tolerance = PK_ScalarNearlyZero) {
    return PkScalarAbs(x) <= tolerance;
}

static inline bool SkScalarNearlyEqual(SkScalar x,
                                       SkScalar y,
