...
#include "pathkit/pathops/SkPathOpsPoint.h"
...
public:
    ...
    int conicHorizontal(const SkPoint a[3],
                        SkScalar weight,
                        SkScalar left,
                        SkScalar right,
                        SkScalar y,
    ...
    int conicVertical(const SkPoint a[3],
                      SkScalar weight,
                      SkScalar top,
                      SkScalar bottom,
                      SkScalar x,
    ...
    int cubicHorizontal(
            const SkPoint a[4], SkScalar left, SkScalar right, SkScalar y, bool flipped) {
        SkDCubic cubic;
        cubic.set(a);
        fMax = 3;
    ...
    int lineHorizontal(
            const SkPoint a[2], SkScalar left, SkScalar right, SkScalar y, bool flipped) {
        SkDLine line;
        line.set(a);
        fMax = 2;
    ...
    int quadHorizontal(
            const SkPoint a[3], SkScalar left, SkScalar right, SkScalar y, bool flipped) {
        SkDQuad quad;
        quad.set(a);
        fMax = 2;
    ...
    void downDepth() { PkASSERT(--fDepth >= 0); }
    ...
    void upDepth() { PkASSERT(++fDepth < 16); }
