...
#include "pathkit/private/SkVx.h"
...
template <typename T>
PK_ALWAYS_INLINE void strided_load4(const T* v,
                                    skvx::Vec<1, T>& a,
                                    skvx::Vec<1, T>& b,
                                    skvx::Vec<1, T>& c,
                                    skvx::Vec<1, T>& d) {
...
PK_ALWAYS_INLINE typename std::enable_if<N >= 2, void>::type strided_load4(const T* v,
                                                                           skvx::Vec<N, T>& a,
                                                                           skvx::Vec<N, T>& b,
                                                                           skvx::Vec<N, T>& c,
                                                                           skvx::Vec<N, T>& d) {
...
template <int N, typename T>
PK_ALWAYS_INLINE typename std::enable_if<N >= 2, void>::type strided_load2(const T* v,
                                                                           skvx::Vec<N, T>& a,
                                                                           skvx::Vec<N, T>& b) {
