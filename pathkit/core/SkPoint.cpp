...
void SkPoint::scale(SkScalar scale, SkPoint* dst) const { dst->set(fX * scale, fY * scale); }

bool SkPoint::normalize() { return this->setLength(fX, fY, PK_Scalar1); }

bool SkPoint::setNormalize(SkScalar x, SkScalar y) { return this->setLength(x, y, PK_Scalar1); }
...
SkScalar SkPointPriv::DistanceToLineBetweenSqd(const SkPoint& pt,
                                               const SkPoint& a,
                                               const SkPoint& b,
                                               Side* side) {
    SkVector u = b - a;
...
SkScalar SkPointPriv::DistanceToLineSegmentBetweenSqd(const SkPoint& pt,
                                                      const SkPoint& a,
                                                      const SkPoint& b) {
