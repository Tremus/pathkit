...
public:
    ...
    */
    static SkMatrix PK_WARN_UNUSED_RESULT MakeAll(SkScalar scaleX,
                                                  SkScalar skewX,
                                                  SkScalar transX,
                                                  SkScalar skewY,
                                                  SkScalar scaleY,
...
public:
    ...
    */
    friend PK_API bool operator!=(const SkMatrix& a, const SkMatrix& b) { return !(a == b); }
...
private:
    ...
    */
    ...
    constexpr SkMatrix(SkScalar sx,
                       SkScalar kx,
                       SkScalar tx,
                       SkScalar ky,
                       SkScalar sy,
    ...
    void setTypeMask(int mask) { fTypeMask = mask; }

    void orTypeMask(int mask) { fTypeMask |= mask; }

    void clearTypeMask(int mask) { fTypeMask &= ~mask; }
