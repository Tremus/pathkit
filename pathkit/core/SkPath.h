...
#include "pathkit/core/SkPathTypes.h"
#include "pathkit/private/SkPathRef.h"
...
public:
    ...
    */
    bool isEmpty() const { return 0 == fPathRef->countVerbs(); }
    ...
    */
    bool isFinite() const { return fPathRef->isFinite(); }
    ...
    */
    static int ConvertConicToQuads(const SkPoint& p0,
                                   const SkPoint& p1,
                                   const SkPoint& p2,
                                   SkScalar w,
                                   SkPoint pts[],
    ...
    */
    ...
    /** Appends SkRRect to SkPath, creating a new closed contour. SkRRect has bounds
        ...
        @return      reference to SkPath
    */
    SkPath& addRoundRect(const SkRect& rect,
                         SkScalar rx,
                         SkScalar ry,
                         SkPathDirection dir = SkPathDirection::kCW);
    ...
    */
    ...
    /** Appends src to SkPath, offset by (dx, dy).
        ...
        @return      reference to SkPath
    */
    SkPath& addPath(const SkPath& src,
                    SkScalar dx,
                    SkScalar dy,
    ...
    */
     ...
     */
    int toTriangles(float tolerance,
...
private:
    SkPath(sk_sp<SkPathRef>, SkPathFillType, SkPathConvexity, SkPathFirstDirection firstDirection);
    ...
    */
     ...
     */
    bool hasComputedBounds() const { return fPathRef->hasComputedBounds(); }
