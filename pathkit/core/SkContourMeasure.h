...
#include "pathkit/core/SkRefCnt.h"
...
public:
     ...
     */
    bool PK_WARN_UNUSED_RESULT getPosTan(SkScalar distance,
                                         SkPoint* position,
    ...
    /** Pins distance to 0 <= distance <= getLength(), and then computes
     ...
     matrix is unchanged.
     */
    bool PK_WARN_UNUSED_RESULT getMatrix(SkScalar distance,
                                         SkMatrix* matrix,
     ...
     */
    bool PK_WARN_UNUSED_RESULT getSegment(SkScalar startD,
                                          SkScalar stopD,
                                          SkPath* dst,
...
private:
    ...
    SkContourMeasure(SkTDArray<Segment>&& segs,
