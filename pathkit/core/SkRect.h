...
#include "pathkit/private/SkSafe32.h"
#include "pathkit/private/SkTFitsIn.h"
...
struct PK_API SkRect {
    ...
    */
    static constexpr SkRect PK_WARN_UNUSED_RESULT MakeEmpty() { return SkRect{0, 0, 0, 0}; }
    ...
    */
    static constexpr SkRect PK_WARN_UNUSED_RESULT MakeLTRB(SkScalar l,
                                                           SkScalar t,
                                                           SkScalar r,
                                                           SkScalar b) {
    ...
    */
    static constexpr SkRect PK_WARN_UNUSED_RESULT MakeXYWH(SkScalar x,
                                                           SkScalar y,
                                                           SkScalar w,
                                                           SkScalar h) {
...
private:
    static bool Intersects(SkScalar al,
                           SkScalar at,
                           SkScalar ar,
                           SkScalar ab,
                           SkScalar bl,
...
public:
    ...
    */
    void roundOut(SkRect* dst) const {
        dst->setLTRB(PkScalarFloorToScalar(fLeft),
                     PkScalarFloorToScalar(fTop),
                     PkScalarCeilToScalar(fRight),
                     PkScalarCeilToScalar(fBottom));
    }
    ...
    */
    SkRect makeSorted() const {
        return MakeLTRB(std::min(fLeft, fRight),
